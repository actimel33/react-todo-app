...
const TaskTypedRadioGroupComponent = () =>  {
  const { newTaskType, seNewTaskType } = useBoardStore();
...
export default memo(TaskTypedRadioGroupComponent);